...
def without_duplicates(words):
    ...
    """
    output = []
    for duplicates in words:
        if duplicates not in output:
...
def find_unique_common_items(list1, list2):
    ...
    """
    first_unique_list = set(list1)
    second_unique_list = set(list2)

    combined_list = first_unique_list.intersection(second_unique_list)
...
def count_unique(input_string):
    ...
    for word in string:
        if word in dictionary_of_uniques:
            dictionary_of_uniques[word] += 1
        else: 
            dictionary_of_uniques[word] = 1

    return dictionary_of_uniques
